...
// natural type maximum, hence the /2 below.
  ...
  if (ImGui::TreeNode("Querying Status (Active/Focused/Hovered etc.)")) {
    ...
    ImGui::BulletText(
        ...
        ImGui::IsItemEdited(), ImGui::IsItemDeactivated(),
    ...
    ImGui::Text(
        "This is another child window for testing with the _ChildWindows "
        "flag.");
    ImGui::EndChild();
...
static void ShowDemoWindowPopups() {
  ...
  // three properties are intimately connected. The library needs to hold their
  ...
  if (ImGui::TreeNode("Modals")) {
    ...
    if (ImGui::BeginPopupModal("Stacked 1")) {
      ...
      ImGui::ColorEdit4("color", color);  // This is to test behavior of stacked
...
static void ShowDemoWindowColumns() {
  ...
  */
  ...
  ImGui::SameLine();
  ShowHelpMarker(
      "NB: Tree node must be poped before ending the cell. There's no storage "
      "of state per-cell.");
  if (node_open) {
...
void ImGui::ShowStyleEditor(ImGuiStyle* ref) {
  ...
  if (ImGui::TreeNode("Rendering")) {
    ...
    ImGui::DragFloat("Curve Tessellation Tolerance",
                     &style.CurveTessellationTol, 0.02f, 0.10f, FLT_MAX, "%.2f",
                     2.0f);
  ...
  if (ImGui::TreeNode("Settings")) {
    ...
    ImGui::SameLine();
    ShowHelpMarker(
        "Adjust if you cannot see the edges of your screen (e.g. on a TV where "
