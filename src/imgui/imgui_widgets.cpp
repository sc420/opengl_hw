...
// FIXME: Logic is awkward and confusing. This should be reworked to facilitate
// using in other situations.
  ...
  if (focus_requested || user_clicked || user_scrolled ||
    ...
    if (g.ActiveId != id) {
      ...
      edit_state.InitialText.resize(
          init_buf_len + 1);  // UTF-8. we use +1 to make sure that .Data isn't
